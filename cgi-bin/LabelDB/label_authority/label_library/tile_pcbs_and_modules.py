...
shape_row_class = (["A5", "A6", "B1", "B2", "C5", "D8", "E8", "G8", "G7", "G5", "G3", "J1", "J2", "K2", "K0", "K8", "K5"])
geometry = (["F", "R", "L"])
material = (["C", "M"])
...
versDict = {"2":"common ground package of HGCROCV3b ASIC", "4":"seperated-ground HGCROCV3b ASIC", "C":"HGCROCV3b ASIC"} 
...
tile_pcb_fields = SerialSchema(
    ...
    MappingField("ManufacturerNumber", "Board manufaturer, currently unspecified", 1, manuDict),
...
def tileSubtypeByCode(major_type, code):
    if code not in tile_pcb_subtypes and code not in tile_module_subtypes:
        return KeyError
    numDict = {"0": "ten", "1": "eleven", "2": "twelve", "3": "three", "5": "five","6":"six", "7": "seven", "8": "eight"}
    shapeDict = {"A":"1", "B":"2", "C":"3", "D":"4", "E":"5", "G":"6", "J":"7", "K":"8"}
    geoDict = {"F":"0", "L":"1", "R":"2"}

...
def create_generic_hist(attachments1, title, stats):
    ...
    for attachment in attachments1:
        values.append(attachment[graph_title])
    ...
    plt.savefig('../static/files/iic/{}.png'.format(graph_title))
    plt.close()


    print('<img src="../static/files/iic/{}.png" >'.format(graph_title))
...
def create_sub_generic_hist(attachments1, title, list_index, stats):
    ...
    values = []
    for attachment in attachments1:
        values.append(attachment[graph_title][list_index])
...
attachments3 = add_test_functions.get_test_attachments(3)
stats = {'analytic_type': "IIC Test"}

#######################################################

create_generic_hist(attachments3, 'num_iic_correct', stats)

########################################################

create_generic_hist(attachments3, 'num_iic_checks', stats)

########################################################

print(json.dumps(stats, indent = 4))

with open('../static/files/iic/iic_stats.json', 'w') as open_file:
